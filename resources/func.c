...
/* Generated from         /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
/* Generated at           Mai 23 2020 10:02:19 */
/* GnuCOBOL build date    Jul 17 2018 20:29:40 */
/* GnuCOBOL package date  Sep 06 2017 18:48:43 UTC */
/* Compile command        cobc -free -x -g -fsource-location -ftraceall -Q --coverage -A --coverage -v /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
...
#define  COB_SOURCE_FILE		"/home/developer/projects/gnucobol-debug/test/resources/func.cbl"
...
func_ (const int entry)
{
  ...
  /* Line: 13        : Entry     func                    : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
  l_2:;
  cob_trace_section (st_2, st_1, 13);
  cob_trace_section (st_3, st_1, 13);
  cob_trace_section (st_4, st_1, 13);

  /* Line: 13        : DISPLAY            : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
  cob_set_location (st_1, 13, NULL, NULL, st_5);
  cob_display (0, 1, 2, &c_1, func_DVD.funcfld (&cob_dyn_0, 2, &f_6, &f_7));

  /* Line: 14        : DISPLAY            : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
  cob_set_location (st_1, 14, NULL, NULL, st_5);
  cob_display (0, 1, 2, &c_2, func_MLP.funcfld (&cob_dyn_1, 2, &f_6, &f_7));

  /* Line: 15        : STOP RUN           : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
...
DVD_ (const int entry, cob_u8_t *b_14, cob_u8_t *b_15)
{
  ...
  /* Line: 27        : Entry     dvd                     : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
  l_5:;
  cob_trace_section (st_8, st_1, 27);
  cob_trace_section (st_3, st_1, 27);
  cob_trace_section (st_4, st_1, 27);

  /* Line: 27        : COMPUTE            : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
...
MLP_ (const int entry, cob_u8_t *b_23, cob_u8_t *b_24)
{
  ...
  /* Line: 39        : Entry     mlp                     : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */
  l_8:;
  cob_trace_section (st_11, st_1, 39);
  cob_trace_section (st_3, st_1, 39);
  cob_trace_section (st_4, st_1, 39);

  /* Line: 39        : COMPUTE            : /home/developer/projects/gnucobol-debug/test/resources/func.cbl */

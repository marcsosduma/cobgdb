...
/* Generated from         /home/developer/projects/gnucobol-debug/test/resources/hello.cbl */
/* Generated at           Apr 23 2020 17:55:55 */
/* GnuCOBOL build date    Jul 17 2018 20:29:40 */
/* GnuCOBOL package date  Sep 06 2017 18:48:43 UTC */
/* Compile command        cobc -free -x -g -d -fdebugging-line -fsource-location -ftraceall /home/developer/projects/gnucobol-debug/test/resources/hello.cbl subsample.cbl subsubsample.cbl */
...
#define  COB_SOURCE_FILE		"/home/developer/projects/gnucobol-debug/test/resources/hello.cbl"
...
hello_ (const int entry)
{
  ...
  /* Line: 7         : Entry     hello                   : /home/developer/projects/gnucobol-debug/test/resources/hello.cbl */
  l_2:;
  cob_trace_section (st_2, st_1, 7);
  cob_trace_section (st_3, st_1, 7);
  cob_trace_section (st_4, st_1, 7);

  /* Line: 7         : MOVE               : /home/developer/projects/gnucobol-debug/test/resources/hello.cbl */
  cob_set_location (st_1, 7, NULL, NULL, st_5);
  memcpy (b_6, "World", 5);

  /* Line: 8         : DISPLAY            : /home/developer/projects/gnucobol-debug/test/resources/hello.cbl */
  cob_set_location (st_1, 8, NULL, NULL, st_6);
  cob_display (0, 1, 2, &c_1, &f_6);

  /* Line: 9         : STOP RUN           : /home/developer/projects/gnucobol-debug/test/resources/hello.cbl */
